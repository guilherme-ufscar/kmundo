    ...
    <section className="bg-white rounded-2xl border border-gray-100 overflow-hidden mb-8">
      <div className="p-6 sm:p-8 space-y-8">
        <div className="space-y-3">
          ...
          {bloco('O Personal Shopper é um serviço onde atuamos como seu agente de compras na Coreia do Sul. Você nos contrata para encontrar, pesquisar e comprar produtos de acordo com a sua solicitação, seja em lojas físicas ou sites coreanos.')}
          {bloco('Criamos esta vitrine com produtos disponíveis diretamente da Coreia do Sul para facilitar sua busca. Você poderá solicitar a compra dos itens apresentados, mas antes da confirmação realizaremos a verificação de disponibilidade, local de compra e valor atualizado.')}
          {bloco('Como trabalhamos com diferentes lojas e plataformas coreanas, os valores podem sofrer alterações. Caso exista alguma mudança de preço, informaremos antes de finalizar a compra.')}
          {bloco('Nós não trabalhamos com estoque próprio. Nosso serviço é realizado sob demanda, com o objetivo de ajudar você a encontrar seus produtos desejados na Coreia do Sul, oferecendo suporte desde a pesquisa até o recebimento da mercadoria em nosso armazém.')}
          {bloco('Caso o produto que você deseja não esteja disponível em nossa vitrine, você pode acessar a área de Pedidos e solicitar sua compra. Envie uma foto, link ou informações do item desejado para que possamos realizar a pesquisa.')}
        </div>
